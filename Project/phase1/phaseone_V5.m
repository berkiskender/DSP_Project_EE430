...
prompt = 'What is the type of  the input signal? \n 0)From microphone 1)From file 2)Data generation';
signal_type = input(prompt) % Sampling rate of input signal Hz
...
%     ylabel('|P1(f)|')
    ...
    Den(:,1)=P1; % audio read de buras? degisecek
